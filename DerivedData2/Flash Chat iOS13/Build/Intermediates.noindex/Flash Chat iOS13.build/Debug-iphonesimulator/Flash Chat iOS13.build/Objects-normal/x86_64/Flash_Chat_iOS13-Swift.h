...
- (IBAction)logOutPressed:(UIBarButtonItem * _Nonnull)sender;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified errorLabelLoginVC;
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified messageBubble;
